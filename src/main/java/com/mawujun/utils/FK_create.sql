...
--alter table dw_history drop constraint fk_dw_history_tablemeta_id;
alter table dw_history add constraint fk_dw_history_tablemeta_id foreign key (tablemeta_id) references dw_tablemeta (id);
--alter table dw_history_coleta drop constraint fk_dw_history_coleta_tablemeta_id;
alter table dw_history_coleta add constraint fk_dw_history_coleta_tablemeta_id foreign key (tablemeta_id) references dw_tablemeta (id);
--alter table dw_history_coleta drop constraint fk_dw_history_coleta_history_id;
alter table dw_history_coleta add constraint fk_dw_history_coleta_history_id foreign key (history_id) references dw_history (id);
--alter table dw_history_tabmeta drop constraint fk_dw_history_tabmeta_classify_id;
alter table dw_history_tabmeta add constraint fk_dw_history_tabmeta_classify_id foreign key (classify_id) references dw_classify (id);
--alter table dw_history_tabmeta drop constraint fk_dw_history_tabmeta_history_id;
alter table dw_history_tabmeta add constraint fk_dw_history_tabmeta_history_id foreign key (history_id) references dw_history (id);
--alter table dw_colclassify drop constraint fk_dw_colclassify_db_id;
alter table dw_colclassify add constraint fk_dw_colclassify_db_id foreign key (db_id) references dw_db (id);
--alter table dw_coldefine drop constraint fk_dw_coldefine_colclassify_id;
alter table dw_coldefine add constraint fk_dw_coldefine_colclassify_id foreign key (colclassify_id) references dw_colclassify (id);
