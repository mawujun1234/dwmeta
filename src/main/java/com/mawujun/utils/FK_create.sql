...
--alter table dw_his_coleta drop constraint fk_dw_his_coleta_tablemeta_id;
alter table dw_his_coleta add constraint fk_dw_his_coleta_tablemeta_id foreign key (tablemeta_id) references dw_tablemeta (id);
--alter table dw_his_coleta drop constraint fk_dw_his_coleta_history_id;
alter table dw_his_coleta add constraint fk_dw_his_coleta_history_id foreign key (history_id) references dw_history (id);
--alter table dw_his_coleta drop constraint fk_dw_his_coleta_columnmeta_id;
alter table dw_his_coleta add constraint fk_dw_his_coleta_columnmeta_id foreign key (columnmeta_id) references dw_columnmeta (id);
...
alter table dw_his_tabmeta add constraint fk_dw_his_tabmeta_history_id foreign key (history_id) references dw_history (id);
