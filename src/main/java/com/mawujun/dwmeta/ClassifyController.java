...
//	}
	...
	@ResponseBody
	public List<ClassifyNode> query4tree(String db_id,String parent_id,String dwlayer_id,ClassifyNodeType type ,Boolean show_deleted) {	
		List<ClassifyNode> classifyes=classifyService.query4tree(db_id,parent_id,type, dwlayer_id,show_deleted);
		return classifyes;
	}
