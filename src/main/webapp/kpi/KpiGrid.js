Ext.define('Ems.kpi.KpiGrid',{
	...
	initComponent: function () {
      ...
      me.columns=[
      	{xtype: 'rownumberer'},
      	{dataIndex:'kpi_type_id',header:'指标类型'
        },
		{dataIndex:'code',header:'编码'
        },
		{dataIndex:'name',header:'名称'
        },
		{dataIndex:'definition',header:'定义'
        },
	  ...
	  me.store=Ext.create('Ext.data.Store',{
			...
			proxy:{
				type: 'ajax',
			    url : Ext.ContextPath+'/kpi/queryAll.do',
	...
	getParams:function(){
    	...
    	var params={
			...
			"params['status']":grid.down("#status").getValue(),
			"params['kpi_type_id']":grid.down("#kpi_type_id").getValue()
	...
	onCreate:function(){
    	var me=this;
		var child=Ext.create('Ems.kpi.Kpi',{
